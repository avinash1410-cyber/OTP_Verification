...
EMAIL_HOST_PASSWORD = os.getenv('SENDGRID_API_KEY')  # Fetch the SendGrid API key from environment variables
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL')  # Fetch from environment
